...
public class EmployeeViewPanel extends BasePanel {
    ...
    private JPanel createOptionCard(String title, Runnable onClick) {
        ...
        card.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                onClick.run(); // Call the provided action
            }
        });
    ...
    private void navigateToInfoPanel() {
        ...
        // EmployeeInfoPanel infoPanel = new EmployeeInfoPanel(mainPanel, employee);
        // mainPanel.add(infoPanel, "EmployeeInfo");
        // navigateToPanel("EmployeeInfo");
    }

    private void navigateToHistoryPanel() {
        // EmployeeHistoryPanel historyPanel = new EmployeeHistoryPanel(mainPanel, employee);
        // mainPanel.add(historyPanel, "EmployeeHistory");
        // navigateToPanel("EmployeeHistory");
    }

    private void navigateToSkillsPanel() {
        // EmployeeSkillsPanel skillsPanel = new EmployeeSkillsPanel(mainPanel, employee);
        // mainPanel.add(skillsPanel, "EmployeeSkills");
        // navigateToPanel("EmployeeSkills");
    }

    private void navigateToTasksPanel() {
        // EmployeeTasksPanel tasksPanel = new EmployeeTasksPanel(mainPanel, employee);
        // mainPanel.add(tasksPanel, "EmployeeTasks");
